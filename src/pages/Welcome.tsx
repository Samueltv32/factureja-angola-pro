...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-angola-red via-red-600 to-angola-black font-inter">
      {/* Hero Section */}
      <div className="container mx-auto px-4 py-8">
        <div className="text-center text-white animate-fade-in">
          ...
          <p className="text-lg opacity-90 mb-12 max-w-xl mx-auto">
            Feito especialmente para empreendedores e pequenos negócios de Angola
          </p>
          
          <Button 
            onClick={() => navigate('/criar-fatura')}
            size="lg"
            className="bg-white text-angola-red hover:bg-gray-100 text-lg px-8 py-6 rounded-xl font-semibold shadow-xl transform hover:scale-105 transition-all duration-200"
          >
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="bg-white/95 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
